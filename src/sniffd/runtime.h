...
void airtraf_init(struct SETTINGS *);

void airtraf_start(struct SETTINGS *);

void airtraf_end(struct SETTINGS *);

int change_channel(int);

/** handy for running gui routine **/
